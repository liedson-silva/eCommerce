      ...
      <div className="bg-white my-4 w-full max-w-lg mx-auto rounded p-7">
        ...
        <form className="grid gap-4 mt-6" onSubmit={handleSubmit}>
          <div className="grid gap-1">
            ...
            <div className="flex itens-center justify-between gap-2 mt-3">
              {data.map((element, index) => {
                return (
                  <input
                    ...
                    maxLength={1}
                    className="bg-blue-50 p-2 w-full max-w-15 border rounded outline-none focus:border-primary-100 text-center font-semibold"
                  />
                );
              })}
            </div>
